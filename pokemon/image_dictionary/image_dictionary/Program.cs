...
namespace image_dictionary
{
    class Program
    {
        ...
        {
            bool[] check = new bool[905];
            Dictionary<string, string> pokemon_dic = new Dictionary<string, string>();
            Dictionary<string, int> pokemon_num = new Dictionary<string, int>();
            ...
            DirectoryInfo image_name = new DirectoryInfo(pokemon_list_path + @"\\pokemon-gen8\\regular");
